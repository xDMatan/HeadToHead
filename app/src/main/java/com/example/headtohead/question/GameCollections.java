...
public class GameCollections {
    ...
    public GameCollections(){
        ...
        HashMap<String, Boolean> ClassQ8 = new HashMap<String, Boolean>();
        ClassQ8.put("רופא", true);
        ClassQ8.put("עורך דין", true);
        ClassQ8.put("מורה", true);
        ClassQ8.put("מהנדס תוכנה", true);
        ClassQ8.put("אחות", true);
        ClassQ8.put("רואה חשבון", true);
        ClassQ8.put("נהג משאית", true);
        ClassQ8.put("שף", true);
        ClassQ8.put("מעצב גרפי", true);
        ClassQ8.put("יועץ עסקי", true);
        ClassQ8.put("מוכר", true);
        ClassQ8.put("חשמלאי", true);
        ClassQ8.put("שרברב", true);
        ClassQ8.put("פסיכולוג", true);
        ClassQ8.put("חקלאי", true);

        ClassicQuestion q8 = new ClassicQuestion("מהם 15 המקצועות הפופולריים ביותר?", "Careers", ClassQ8, false);
        classisCollection.add(q8);
